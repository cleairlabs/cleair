...
export const agentRagRunEvents: FlowGraphEvent[] = [
  ...
  { type: "node_added", node: { id: "retrieve", parentId: "root", label: "retrieve", subtitle: "fetch context", kind: "rag", whatDescription: "Retrieval pipeline runs.", whyDescription: "Grounds the answer in evidence." } },
